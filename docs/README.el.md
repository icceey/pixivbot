...
[简体中文](../README.md) | [English](README.en.md) | [繁體中文](README.zh-TW.md) | [文言文](README.lzh.md) | [Esperanto](README.eo.md) | Ελληνικά | [संस्कृतम्](README.sa.md) | [火星语](README.mars.md) | [Kiswahili](README.sw.md)
...
- `/settings` - Εμφάνιση και διαχείριση ρυθμίσεων συνομιλίας (διαδραστική διεπαφή με ενσωματωμένα κουμπιά)
  - Εναλλαγή θολώματος για ευαίσθητο περιεχόμενο
  - Επεξεργασία ευαίσθητων ετικετών
  - Επεξεργασία εξαιρούμενων ετικετών
- `/cancel` - Ακύρωση τρέχουσας λειτουργίας ρυθμίσεων
- `/download <url|id>` - Λήψη πρωτότυπων εικόνων (ή απάντηση σε μήνυμα)
