...
[简体中文](../README.md) | [English](README.en.md) | [繁體中文](README.zh-TW.md) | [文言文](README.lzh.md) | [Esperanto](README.eo.md) | [Ελληνικά](README.el.md) | [संस्कृतम्](README.sa.md) | [火星语](README.mars.md) | Kiswahili
...
- `/settings` - Onyesha na dhibiti mipangilio ya mazungumzo (kiolesura cha mwingiliano na vitufe vilivyowekwa ndani)
  - Badilisha kubana kwa maudhui nyeti
  - Hariri lebo nyeti
  - Hariri lebo zilizotengwa
- `/cancel` - Ghairi operesheni ya sasa ya mipangilio
- `/download <url|id>` - Pakua picha asili (au jibu ujumbe)
